...
import { NetworkData } from '@/components/network/network'
...
const XRPL: React.FC = () => {
  ...
  const whalePriceData = [
    ...
    { date: '21:00', value: 670000, transactions: 0.7 },
  ]
  ...
  return (
    <Layout
      ...
      header={{
        onSubmit: (type: string, value: string) => handleGetInfo(type, value),
      }}
    >
