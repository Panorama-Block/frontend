  ...
  return (
    <div id="about" className="flex flex-col lg:flex-row relative w-full">
      ...
      <div className="flex flex-col gap-8 flex-1 pt-24 pb-6 lg:py-24 px-12">
        ...
        <h2 className="text-landing-title text-xl md:text-2xl lg:text-3xl xl:text-4xl lg:px-0 2xl:pr-8">Agentic Economy Engineered through Academic Alliances.</h2>
        <div className="absolute w-1/2 h-[1px] bg-landing-border hidden xl:block top-48 left-0"></div>
        <span className="text-landing-text font-normal lg:mt-4 text-lg md:text-xl lg:text-2xl lg:px-0 lg:pr-8">
